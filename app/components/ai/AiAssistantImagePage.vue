<template>
  <div
    ref="aiAssistantPageRef"
    class="ai-assistant-page"
    :class="{ 'ai-assistant-page--task-image-embed': isTaskImageEmbedMode }"
    :style="pageAdaptiveStyle"
  >
    <div
      class="ai-assistant-container"
      :class="{ 'ai-assistant-container--task-image-embed': isTaskImageEmbedMode }"
    >
      <TeacherSidebar v-if="!isTaskImageEmbedMode" />
      ...
      <div class="ai-assistant-content">
        <div
          ...
          :class="{
            ...
            'ai-assistant-shell--task-image-embed': isTaskImageEmbedMode,
          }"
        >
          <section
            v-if="showBreadcrumb"
          ...
          >
            <h1 class="ai-assistant-hero__title">{{ t("ai.homePage.heroTitle") }}</h1>
            <div class="ai-assistant-hero__desc-row">
              <p class="ai-assistant-hero__desc">{{ t("ai.homePage.heroDesc") }}</p>
          ...
          >
            <div v-if="!isCodeAssistantMode" class="ai-assistant-chat__header">
              ...
              <!-- <button type="button" class="ai-assistant-chat__new" @click="startNewChat">
                ...
                <span>{{ t("ai.homePage.modePages.chat.newSession") }}</span>
              </button> -->
            </div>
              ...
              <div v-if="lessonChatEditorExpanded" class="ai-chat-lesson-editor__body">
                ...
                <label v-if="shouldShowLessonGrade" class="ai-assistant-lesson__label">
                  <span>
                    ...
                    <span>{{ t("ai.homePage.modePages.lesson.gradeLabel") }}</span>
                  </span>
                  <MSelect
                    v-model="lessonPlanForm.grade"
                    :options="lessonPlanGradeOptions"
                    :placeholder="t('ai.homePage.modePages.lesson.gradePlaceholder')"
                ...
                >
                  <span class="ai-assistant-lesson__label-text">
                    <span class="ai-assistant-lesson__required">*</span>
                    <span>{{ t("ai.homePage.modePages.lesson.questionKindLabel") }}</span>
                  </span>
                  <label class="ai-assistant-lesson__radio">
                    <input
                      ...
                      value="scene"
                    />
                    <span>{{ t("ai.homePage.modePages.lesson.questionKindScene") }}</span>
                  </label>
                  <label class="ai-assistant-lesson__radio">
                    <input
                      v-model="lessonPlanForm.questionKind"
                      ...
                      value="knowledge"
                    />
                    <span>{{ t("ai.homePage.modePages.lesson.questionKindKnowledge") }}</span>
                  </label>
                </div>
                ...
                >
                  <span class="ai-assistant-lesson__label-text">
                    <span class="ai-assistant-lesson__required">*</span>
                    <span>{{ t("ai.homePage.modePages.lesson.unitTypeLabel") }}</span>
                  </span>
                  <label class="ai-assistant-lesson__radio">
                    <input
                      ...
                      value="single"
                    />
                    <span>{{ t("ai.homePage.modePages.lesson.unitTypeSingle") }}</span>
                  </label>
                  <label class="ai-assistant-lesson__radio">
                    <input
                      v-model="lessonPlanForm.unitType"
                      ...
                      value="unit"
                    />
                    <span>{{ t("ai.homePage.modePages.lesson.unitTypeUnit") }}</span>
                  </label>
                </div>
                ...
                >
                  <span>
                    <span class="ai-assistant-lesson__required">*</span>
                    <span>{{ t("ai.homePage.modePages.lesson.periodCountLabel") }}</span>
                  </span>
                  <MSelect
                    v-model="lessonPlanForm.periodCount"
                    :options="lessonPlanPeriodOptions"
                    :placeholder="t('ai.homePage.modePages.lesson.periodCountPlaceholder')"
                    class="ai-assistant-lesson__mselect"
                    dropdown-class="ai-lesson-select-dropdown"
                  />
                </label>
                ...
                <label class="ai-assistant-lesson__label">
                  ...
                  <div class="ai-assistant-lesson__textarea-wrap">
                    <textarea
                      ...
                      :placeholder="t('ai.homePage.modePages.lesson.subjectPlaceholder')"
                      rows="3"
                    ></textarea>
                ...
                <label class="ai-assistant-lesson__label">
                  <span>
                    ...
                    <span>{{ t("ai.homePage.modePages.lesson.scenarioLabel") }}</span>
                  </span>
                  <MSelect
                    v-model="lessonPlanForm.scenario"
                    :options="lessonPlanScenarioOptions"
                    :placeholder="t('ai.homePage.modePages.lesson.scenarioPlaceholder')"
                    class="ai-assistant-lesson__mselect"
                    dropdown-class="ai-lesson-select-dropdown"
                    filterable
                  />
                ...
                >
                  <span class="ai-assistant-lesson__label-text">
                    <span class="ai-assistant-lesson__required">*</span>
                    <span>{{ t("ai.homePage.modePages.lesson.questionTypesLabel") }}</span>
                  </span>
                  <div class="ai-assistant-lesson__question-types">
                    <div class="ai-assistant-lesson__question-item ai-assistant-lesson__question-item--single">
                      <span class="ai-assistant-lesson__question-chip">{{ t("ai.homePage.modePages.lesson.questionSingle") }}</span>
                      <MSelect
                    ...
                    <div class="ai-assistant-lesson__question-item ai-assistant-lesson__question-item--multiple">
                      <span class="ai-assistant-lesson__question-chip">{{ t("ai.homePage.modePages.lesson.questionMultiple") }}</span>
                      <MSelect
                    ...
                    <div class="ai-assistant-lesson__question-item ai-assistant-lesson__question-item--judge">
                      <span class="ai-assistant-lesson__question-chip">{{ t("ai.homePage.modePages.lesson.questionJudge") }}</span>
                      <MSelect
                    ...
                    <div class="ai-assistant-lesson__question-item ai-assistant-lesson__question-item--blank">
                      <span class="ai-assistant-lesson__question-chip">{{ t("ai.homePage.modePages.lesson.questionBlank") }}</span>
                      <MSelect
                    ...
                    <div class="ai-assistant-lesson__question-item ai-assistant-lesson__question-item--connect">
                      <span class="ai-assistant-lesson__question-chip">{{ t("ai.homePage.modePages.lesson.questionConnect") }}</span>
                      <MSelect
                ...
                <div class="ai-assistant-lesson__double">
                  <label class="ai-assistant-lesson__label">
                    <span>{{ t("ai.homePage.modePages.lesson.teachToolLabel") }}</span>
                    <MSelect
                      v-model="lessonPlanForm.teachTool"
                      :options="lessonPlanToolOptions"
                      :placeholder="t('ai.homePage.modePages.lesson.teachToolPlaceholder')"
                      class="ai-assistant-lesson__mselect"
                      dropdown-class="ai-lesson-select-dropdown"
                    />
                  </label>
                  <label class="ai-assistant-lesson__label">
                    <span>{{ t("ai.homePage.modePages.lesson.hardwareLabel") }}</span>
                    <MSelect
                      v-model="lessonPlanForm.hardware"
                      :options="lessonPlanHardwareOptions"
                      :placeholder="t('ai.homePage.modePages.lesson.hardwarePlaceholder')"
                      class="ai-assistant-lesson__mselect"
                      dropdown-class="ai-lesson-select-dropdown"
                    />
                  </label>
                ...
                <label class="ai-assistant-lesson__label">
                  ...
                  >
                    <span>{{ t("ai.homePage.modePages.lesson.requirementLabel") }}</span>
                    <button
                      v-if="lessonPlanSessionType === 2"
                      type="button"
                    ...
                    >
                      <span>{{ t("ai.homePage.modePages.lesson.commonPrompts") }}</span>
                    ...
                    >
                      <p class="ai-assistant-lesson__helper-title">{{ t("ai.homePage.modePages.lesson.requirementExamples") }}</p>
                      <button
                  ...
                  <div class="ai-assistant-lesson__textarea-wrap">
                    <textarea
                      ...
                      :placeholder="t('ai.homePage.modePages.lesson.requirementPlaceholder')"
                      rows="3"
                    ></textarea>
                    <span class="ai-assistant-lesson__count">
                ...
                <label class="ai-assistant-lesson__label">
                  <span>{{ t("ai.homePage.modePages.lesson.standardLabel") }}</span>
                  <div
                ...
                <div class="ai-assistant-lesson-upload">
                  <div class="ai-assistant-lesson-upload__label-wrap">
                    <span class="ai-assistant-lesson-upload__label">{{ t("ai.homePage.modePages.lesson.uploadLabel") }}</span>
            ...
            >
              <div v-if="isCodeAssistantMode" class="ai-code-assistant-layout">
                <div class="ai-code-assistant ai-code-assistant--top">
                  <h3 class="ai-code-assistant__title">{{ t("ai.homePage.sessionTypes.code") }}</h3>
                  ...
                  <div class="ai-code-assistant__panel">
                    ...
                    <div class="ai-code-assistant__panel-main">
                      <p class="ai-code-assistant__hero-text">
                        {{ t("ai.homePage.modePages.code.heroText") }}
                      </p>
              ...
              >
                ...
                <div class="ai-chat-message__bubble-wrap">
                    ...
                    >
                      ...
                      >
                        ...
                        <strong>
                          {{
                            item.pending
                              ? t("ai.homePage.modePages.chat.thinking")
                              : t("ai.homePage.modePages.chat.thinkingStopped")
                          }}
                        </strong>
                        <span
                      ...
                      >
                        ...
                        <div
                        v-if="item.content && item.content !== t('ai.homePage.modePages.chat.thinkingContent')"
                  ...
                  >
                    ...
                    >
                      <span class="material-symbols-outlined">content_copy</span>
                      <span>{{ t("ai.homePage.messageActions.copy") }}</span>
                    </button>
                    <button
                      type="button"
                      class="ai-chat-message__action"
                    ...
                    >
                      ...
                      <span>{{ t("ai.homePage.messageActions.retryOnce") }}</span>
                    </button>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <span>{{ t("ai.homePage.messageActions.generatePpt") }}</span>
                      </button>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <span>{{
                          isPptGenerateMode
                            ? t("ai.homePage.messageActions.generatePpt")
                            : isExerciseGenerateMode
                              ? t("ai.homePage.messageActions.generateQuiz")
                              : t("ai.homePage.messageActions.generateFile")
                        }}</span>
                      </button>
                      <div
                      ...
                      >
                        <template v-if="isPptGenerateMode">
                          <div class="ai-chat-message__generate-group">
                            ...
                            >
                              {{ t("ai.homePage.generateMenu.openPptInExistingCourse") }}
                            </button>
                            <button type="button" @click="handleGenerateFileAction('ppt-new')">
                              {{ t("ai.homePage.generateMenu.createNewCourseAndOpen") }}
                            </button>
                          </div>
                        </template>
                        <template v-else-if="isExerciseGenerateMode">
                          <div class="ai-chat-message__generate-group">
                            ...
                            >
                              {{ t("ai.homePage.generateMenu.modifyLinkedCourse") }}
                            </button>
                            <button
                              type="button"
                              @click="handleGenerateFileAction('exercise-new')"
                            >
                              {{ t("ai.homePage.generateMenu.customEditQuiz") }}
                            </button>
                          </div>
                        </template>
                        <template v-else>
                          <div class="ai-chat-message__generate-group">
                            <strong>{{ t("ai.homePage.generateMenu.lessonPlan") }}</strong>
                            <button
                              type="button"
                              @click="handleGenerateFileAction('lesson-existing')"
                            >
                              {{ t("ai.homePage.generateMenu.openInExistingCourse") }}
                            </button>
                            <button
                              type="button"
                          ...
                          <div class="ai-chat-message__generate-group">
                            <strong>{{ t("ai.homePage.generateMenu.ppt") }}</strong>
                            <button
                              type="button"
                              @click="handleGenerateFileAction('ppt-existing')"
                            >
                          ...
                          <div class="ai-chat-message__generate-group">
                            <strong>{{ t("ai.homePage.generateMenu.quiz") }}</strong>
                            <button
                              type="button"
                              @click="handleGenerateFileAction('exercise-new')"
                            >
                              {{ t("ai.homePage.generateMenu.generateQuiz") }}
                            </button>
                          </div>
                        </template>
                      </div>
                  ...
                  >
                    <span class="ai-chat-message__stopped-label">
                      {{ t("ai.homePage.messageActions.stopped") }}
                    </span>
                    <button
                      type="button"
                  ...
                  >
                    <p class="ai-chat-message__suggestions-label">
                      {{ t("ai.homePage.messageActions.moreQuestions") }}
                    </p>
            ...
            <div v-if="isStreamingReply" class="ai-chat-toolbar">
              <button type="button" class="ai-chat-toolbar__stop" @click="stopAiReply">
                ...
                <span>{{ t("ai.homePage.modePages.chat.stopReply") }}</span>
              </button>
            </div>
            <div v-else-if="canRetryStoppedMessage" class="ai-chat-toolbar">
              ...
              >
                <span class="material-symbols-outlined">refresh</span>
                <span>{{ t("ai.homePage.modePages.chat.retryReply") }}</span>
              </button>
            </div>
          </section>
          ...
          <section v-else-if="isLessonPlanMode" class="ai-assistant-lesson">
              ...
              <div class="ai-assistant-lesson__header-actions">
                ...
                >
                  <button type="button" class="ai-assistant-quota-entry">
                    ...
                    <span>{{ t("ai.homePage.quotaDetail") }}</span>
                  </button>
                ...
                >
                  ...
                  <span>{{ t("ai.homePage.history") }}</span>
                </button>
              </div>
            </div>
            ...
            <div class="ai-assistant-lesson__footer">
              <button
                ...
                @click="handleLessonPlanSubmit"
              >
                {{ t("ai.homePage.modePages.lesson.submit") }}
              </button>
            </div>
          </section>
          ...
          <section v-else-if="isAnalysisMode" class="ai-analysis">
            <div class="ai-assistant-lesson__header">
              ...
              <h2 class="ai-assistant-lesson__title">{{ t("ai.homePage.sessionTypes.analysis") }}</h2>
              <div class="ai-assistant-lesson__header-actions">
                <div
                  class="ai-assistant-quota"
                  @mouseenter="handleQuotaMouseEnter"
            ...
            <div class="ai-analysis__form">
              <label class="ai-analysis__label">
                <span class="ai-assistant-lesson__label-text">
                  <span class="ai-assistant-lesson__required">*</span>
                  <span>{{ t("ai.homePage.modePages.analysis.dateRangeLabel") }}</span>
                </span>
                <MDateRangePicker
              ...
              <label class="ai-analysis__label">
                <span class="ai-assistant-lesson__label-text">
                  <span class="ai-assistant-lesson__required">*</span>
                  <span>{{ t("ai.homePage.modePages.analysis.gradeClassLabel") }}</span>
                </span>
                <div ref="analysisTargetPickerRef" class="ai-analysis-target">
                  ...
                  >
                    ...
                    <span v-else class="ai-analysis-target__placeholder">
                      {{ t("ai.homePage.modePages.analysis.gradeClassPlaceholder") }}
                    </span>
                  ...
                  <div v-if="analysisTargetDropdownVisible" class="ai-analysis-target__dropdown">
                    ...
                    <div v-else class="ai-analysis-target__body">
                      ...
                      <div class="ai-analysis-target__classes">
                        ...
                        <div v-else class="ai-analysis-target__status">
                          {{ t("ai.homePage.modePages.analysis.selectGradeFirst") }}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <label class="ai-analysis__label">
                <span class="ai-assistant-lesson__label-text">{{ t("ai.homePage.modePages.analysis.requirementLabel") }}</span>
                <div class="ai-assistant-lesson__textarea-wrap">
                  <textarea
                    ...
                    :placeholder="t('ai.homePage.modePages.analysis.requirementPlaceholder')"
                    rows="3"
                  ></textarea>
                  <span class="ai-assistant-lesson__count">
            ...
            <div class="ai-assistant-lesson__footer">
              ...
              >
                {{ chatRequesting ? t("ai.homePage.modePages.analysis.submitting") : t("ai.homePage.modePages.analysis.submit") }}
              </button>
            </div>
          </section>
              ...
              <aside class="ai-image__panel">
                <label class="ai-image__panel-block ai-image__label">
                  <span class="ai-image__block-head">
                    <span class="ai-image__label-text">
                      <span class="ai-assistant-lesson__required">*</span>
                      <span>{{ t("ai.homePage.modePages.image.promptLabel") }}</span>
                    </span>
                  ...
                  <div class="ai-image__textarea-wrap">
                    <textarea
                      ...
                      :placeholder="t('ai.homePage.modePages.image.promptPlaceholder')"
                      rows="5"
                    ></textarea>
                    <div class="ai-image__prompt-tags">
                      ...
                      >
                        <span class="material-symbols-outlined">add</span>
                        <span>{{ t("ai.homePage.modePages.image.addTag") }}</span>
                      </button>
                    </div>
                    <div v-if="showImagePromptTagEditor" class="ai-image__prompt-tag-editor">
                      <input
                        ...
                        :placeholder="t('ai.homePage.modePages.image.tagPlaceholder')"
                      ...
                      >
                        {{ t("ai.homePage.modePages.image.tagAdd") }}
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        {{ t("ai.homePage.modePages.image.tagCancel") }}
                      </button>
                    </div>
                  </div>
                </label>
                ...
                <div class="ai-image__panel-block ai-image__upload">
                  <div class="ai-image__block-head">
                    <span class="ai-image__label-text">{{ t("ai.homePage.modePages.image.referenceLabel") }}</span>
                    <span class="ai-image__label-caption">{{ t("ai.homePage.modePages.image.optional") }}</span>
                  </div>
                  <div class="ai-image__upload-body">
                    ...
                    >
                      ...
                      <strong>{{ t("ai.homePage.modePages.image.referenceUpload") }}</strong>
                      <small>{{ t("ai.homePage.modePages.image.referenceHint") }}</small>
                    </button>
                    <div v-else class="ai-image__upload-card">
                      <img
                        ...
                        :alt="t('ai.homePage.modePages.image.referencePreviewAlt')"
                      />
                ...
                <div class="ai-image__panel-block ai-image__size">
                  <div class="ai-image__block-head">
                    <span class="ai-image__label-text">{{ t("ai.homePage.modePages.image.sizeLabel") }}</span>
                    <span class="ai-image__label-caption">{{ t("ai.homePage.modePages.image.sizeHint") }}</span>
                  </div>
                ...
                <div class="ai-image__footer">
                  <p class="ai-image__quota-text">
                    {{ t("ai.homePage.modePages.image.remainingQuota", { count: imageQuotaRemainText }) }}
                  </p>
                  <button
                    type="button"
                  ...
                  >
                    {{
                      imageGenerating
                        ? t("ai.homePage.modePages.image.submitting")
                        : t("ai.homePage.modePages.image.submit")
                    }}
                  </button>
                </div>
              </aside>
              ...
              <section class="ai-image__preview">
                <div class="ai-image__preview-stage">
                  ...
                  >
                    ...
                    <p>{{ t("ai.homePage.modePages.image.historyLoading") }}</p>
                    <small>{{ t("ai.homePage.modePages.image.historyLoadingHint") }}</small>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <small>{{ t("ai.homePage.modePages.image.generatingHint") }}</small>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p>{{ t("ai.homePage.modePages.image.emptyTitle") }}</p>
                    <small>{{ t("ai.homePage.modePages.image.emptyHint") }}</small>
                  </div>
                  <div v-else class="ai-image__result-wrap">
                    <div class="ai-image__result-card">
                      <img
                        ...
                        :alt="t('ai.homePage.modePages.image.resultAlt')"
                      />
                    </div>
                  </div>
                </div>

                <div v-if="!shouldHideImageHistoryEntry" class="ai-image__gallery">
                  <div class="ai-image__gallery-head">
                    <span class="ai-image__gallery-title">{{ t("ai.homePage.modePages.image.recentTitle") }}</span>
                    <button
                      type="button"
                      class="ai-image__gallery-more"
                      @click="handleOpenHistory"
                    >
                      <span>{{ t("ai.homePage.modePages.image.viewMore") }}</span>
                  ...
                  <div v-if="imageRecentHistoryList.length > 0" class="ai-image__thumb-list">
                    ...
                    >
                      <img
                        ...
                        :alt="t('ai.homePage.modePages.image.historyThumbAlt')"
                      />
          ...
          >
            <div v-if="!isCodeAssistantMode" class="ai-assistant-search__head">
              <div class="ai-assistant-search__head-actions">
                ...
                <button
                  ...
                  :title="t('ai.homePage.modePages.chat.closeSession')"
                  :aria-label="t('ai.homePage.modePages.chat.closeSession')"
            ...
            <div v-if="isCodeAssistantMode" class="ai-code-assistant__bottom">
              ...
              <p class="ai-code-assistant__hint">
                {{ t("ai.homePage.modePages.code.hint") }}
              </p>
            </div>
              ...
              <div class="ai-assistant-search__panel">
                <div class="ai-assistant-search__main">
                  ...
                  <textarea
                    ...
                    :placeholder="t('ai.homePage.searchPlaceholder')"
                ...
                <div class="ai-assistant-search__footer">
                  <span class="ai-assistant-search__hint">{{ t("ai.homePage.searchHint") }}</span>
                  ...
                  >
                    ...
                    <span>{{ t("ai.homePage.deepThinking") }}</span>
                  </button>
                  ...
                  <button
                    ...
                    @click="handleSearch"
                  >
                    <span>{{ isChatMode ? t("ai.homePage.modePages.chat.send") : t("ai.homePage.askButton") }}</span>
                    <span
            ...
            >
              <span class="ai-assistant-hot__label">{{ t("ai.homePage.hotTopics") }}</span>
              <button
        ...
        <div class="ai-history-panel" @click.stop>
          <div class="ai-history-panel__header">
            <div class="ai-history-panel__title-wrap">
              <h2 class="ai-history-panel__title">{{ t("ai.homePage.historyPanel.title") }}</h2>
              <p class="ai-history-panel__subtitle">
                {{ t("ai.homePage.historyPanel.subtitle") }}
              </p>
            </div>
            <div class="ai-history-panel__actions">
              <span class="ai-history-panel__count"
                >{{ t("ai.homePage.historyPanel.count", { count: filteredHistoryList.length }) }}</span
              >
              <button
                type="button"
          ...
          <div class="ai-history-toolbar">
            <MSelect
              ...
              :placeholder="t('ai.homePage.historyPanel.filterPlaceholder')"
          ...
          <div class="ai-history-list-wrap">
            <div v-if="historyLoading" class="ai-history-empty">
              ...
              >
              <p class="ai-history-empty__text">
                {{ t("ai.homePage.historyPanel.loading") }}
              </p>
            </div>
            ...
            <div v-else class="ai-history-empty">
              ...
              >
              <p class="ai-history-empty__text">
                {{ t("ai.homePage.historyPanel.empty") }}
              </p>
            </div>
          </div>
        </div>
...
const props = withDefaults(
  defineProps<{
    ...
    resetImageModeOnMount?: boolean;
    resetChatModeOnMount?: boolean;
    taskImageEmbed?: boolean;
    taskChatEmbed?: boolean;
    hideImageHistoryEntry?: boolean;
    selectedSessionId?: string;
  }>(),
  {
    forceImageMode: false,
    forceChatMode: false,
    resetImageModeOnMount: false,
    resetChatModeOnMount: false,
    taskImageEmbed: false,
    taskChatEmbed: false,
    hideImageHistoryEntry: false,
    selectedSessionId: "",
  }
);
...
const emit = defineEmits<{
  ...
  (event: "chat-session-ready", payload: { sessionId: string }): void;
  (
...
const lessonPlanStandardOptions = computed(() => [
  {
    value: "standard-compulsory-it-2022",
    label: t("ai.homePage.modePages.lesson.standards.compulsoryIt2022"),
  },
  {
    value: "standard-highschool-it-2017-2020",
    label: t("ai.homePage.modePages.lesson.standards.highschoolIt20172020"),
  },
  {
    value: "standard-ai-guide-primary-secondary",
    label: t("ai.homePage.modePages.lesson.standards.aiGuidePrimarySecondary"),
  },
  {
    value: "standard-compulsory-curriculum-plan-2022",
    label: t("ai.homePage.modePages.lesson.standards.compulsoryCurriculumPlan2022"),
  },
  {
    value: "standard-ai-literacy-framework",
    label: t("ai.homePage.modePages.lesson.standards.aiLiteracyFramework"),
  },
  {
    value: "standard-ai-course-development",
    label: t("ai.homePage.modePages.lesson.standards.aiCourseDevelopment"),
  },
  {
    value: "standard-ai4k12",
    label: t("ai.homePage.modePages.lesson.standards.ai4k12"),
  },
]);
...
const CODE_ASSISTANT_MODE_OPTIONS: CodeAssistantModeOption[] = [
  {
    value: "generate",
    title: t("ai.homePage.modePages.code.modes.generate.title"),
    desc: t("ai.homePage.modePages.code.modes.generate.desc"),
    icon: "code_blocks",
  },
  {
    value: "explain",
    title: t("ai.homePage.modePages.code.modes.explain.title"),
    desc: t("ai.homePage.modePages.code.modes.explain.desc"),
    icon: "article",
  },
  {
    value: "debug",
    title: t("ai.homePage.modePages.code.modes.debug.title"),
    desc: t("ai.homePage.modePages.code.modes.debug.desc"),
    icon: "rule_settings",
  },
];
...
const lessonRequirementTips = computed(() => [
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.method"),
    text: t("ai.homePage.modePages.lesson.requirementTips.method5e"),
  },
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.studentProfile"),
    text: t("ai.homePage.modePages.lesson.requirementTips.weakFoundation"),
  },
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.studentProfile"),
    text: t("ai.homePage.modePages.lesson.requirementTips.pythonFoundation"),
  },
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.studentProfile"),
    text: t("ai.homePage.modePages.lesson.requirementTips.advancedStudents"),
  },
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.process"),
    text: t("ai.homePage.modePages.lesson.requirementTips.groupCollaboration"),
  },
  {
    tag: t("ai.homePage.modePages.lesson.requirementTipTags.materials"),
    text: t("ai.homePage.modePages.lesson.requirementTips.limitedEquipment"),
  },
]);
...
const AI_UPLOAD_TOOLTIP_TEXT = computed(() => t("ai.homePage.uploadTooltip"));
...
const analysisDatePresets = computed(() => {
  ...
  return [
    {
      key: "all",
      label: t("ai.homePage.modePages.analysis.presets.all"),
      start: ANALYSIS_DATE_START,
      end: todayText,
    },
    {
      key: "last-month",
      label: t("ai.homePage.modePages.analysis.presets.lastMonth"),
      start: previousMonthStart,
      end: previousMonthEnd,
    },
    {
      key: "this-month",
      label: t("ai.homePage.modePages.analysis.presets.thisMonth"),
      start: currentMonthStart,
      end: todayText,
    },
    {
      key: "custom",
      label: t("ai.homePage.modePages.analysis.presets.custom"),
...
const analysisSelectedTagList = computed<AnalysisSelectedTag[]>(() => {
  if (analysisIsAllSelected.value) {
    return [
      {
        key: ANALYSIS_ALL_GRADE_VALUE,
        label: t("ai.homePage.modePages.analysis.allGrades"),
        type: "all",
      },
    ];
  }
...
const imageGenerateProgressText = computed(() => {
  ...
  return percent > 0
    ? t("ai.homePage.modePages.image.generatingWithPercent", { percent })
    : t("ai.homePage.modePages.image.generating");
});
...
const codeAssistantRequirementPlaceholder = computed(() => {
  if (codeAssistantForm.mode === "generate") {
    return t("ai.homePage.modePages.code.placeholders.generate");
  }
  if (codeAssistantForm.mode === "debug") {
    return t("ai.homePage.modePages.code.placeholders.debug");
  }
  return t("ai.homePage.modePages.code.placeholders.explain");
});
...
const lessonPlanModeTitle = computed(() => {
  if (lessonPlanSessionType.value === 3) return t("ai.homePage.sessionTypes.ppt");
  if (lessonPlanSessionType.value === 4) return t("ai.homePage.sessionTypes.quiz");
  return t("ai.homePage.sessionTypes.lessonPlan");
});
const lessonPlanModeSubjectLabel = computed(() =>
  lessonPlanSessionType.value === 3
    ? t("ai.homePage.modePages.lesson.subjectLabelPpt")
    : t("ai.homePage.modePages.lesson.subjectLabel")
);
const lessonPlanModeStandardPlaceholder = computed(() =>
  lessonPlanSessionType.value === 3
    ? t("ai.homePage.modePages.lesson.standardPlaceholderPpt")
    : lessonPlanSessionType.value === 4
      ? t("ai.homePage.modePages.lesson.standardPlaceholderQuiz")
      : t("ai.homePage.modePages.lesson.standardPlaceholder")
);
const chatModeTitle = computed(() => {
  if (lessonPlanChatActive.value) return lessonPlanModeTitle.value;
  if (chatSessionType.value === 5) return t("ai.homePage.sessionTypes.code");
  if (chatSessionType.value === 6) return t("ai.homePage.sessionTypes.analysis");
  if (chatSessionType.value === 7) return t("ai.homePage.sessionTypes.image");
  return t("ai.homePage.sessionTypes.chat");
});
const chatModeSubtitle = computed(() => {
  if (chatSessionType.value === 5) {
    return t("ai.homePage.modePages.chat.subtitles.code");
  }
  if (chatSessionType.value === 6) {
    return t("ai.homePage.modePages.chat.subtitles.analysis");
  }
  if (chatSessionType.value === 7) {
    return t("ai.homePage.modePages.chat.subtitles.image");
  }
  return t("ai.homePage.modePages.chat.subtitles.default");
});
const assistantCurrentTitle = computed(() => {
  ...
  if (isAnalysisMode.value) return t("ai.homePage.sessionTypes.analysis");
  if (isImageMode.value) return t("ai.homePage.sessionTypes.image");
  return t("ai.homePage.heroTitle");
});

const breadcrumbRootLabel = computed(() =>
  route.path.startsWith("/system/opt") ? t("menu.aiCenter") : t("ai.homePage.heroTitle")
);
...
const showBreadcrumb = computed(() => {
  if (isTaskImageEmbedMode.value) return false;
...
const normalCards = computed<AssistantCard[]>(() => [
  {
    key: "lesson-plan",
    title: t("ai.homePage.cards.lessonPlan.title"),
    desc: t("ai.homePage.cards.lessonPlan.desc"),
    action: t("ai.homePage.cards.lessonPlan.action"),
    icon: "description",
  },
  {
    key: "ppt",
    title: t("ai.homePage.cards.ppt.title"),
    desc: t("ai.homePage.cards.ppt.desc"),
    action: t("ai.homePage.cards.ppt.action"),
    icon: "present_to_all",
  },
  {
    key: "quiz",
    title: t("ai.homePage.cards.quiz.title"),
    desc: t("ai.homePage.cards.quiz.desc"),
    action: t("ai.homePage.cards.quiz.action"),
    icon: "assignment",
  },
  {
    key: "code",
    title: t("ai.homePage.cards.code.title"),
    desc: t("ai.homePage.cards.code.desc"),
    action: t("ai.homePage.cards.code.action"),
    icon: "terminal",
  },
  {
    key: "analysis",
    title: t("ai.homePage.cards.analysis.title"),
    desc: t("ai.homePage.cards.analysis.desc"),
    action: t("ai.homePage.cards.analysis.action"),
    icon: "analytics",
  },
  {
    key: "image",
    title: t("ai.homePage.cards.image.title"),
    desc: t("ai.homePage.cards.image.desc"),
    action: t("ai.homePage.cards.image.action"),
    icon: "image",
  },
]);

const highlightCard = computed<AssistantCard>(() => ({
  key: "immersive",
  title: t("ai.homePage.highlight.title"),
  desc: t("ai.homePage.highlight.desc"),
  action: t("ai.homePage.highlight.action"),
  icon: "image",
}));

const resolveAiSessionTypeLabelBySessionType = (sessionType: string) => {
  switch (String(sessionType || "").trim()) {
    case "1":
      return t("ai.homePage.sessionTypes.chat");
    case "2":
      return t("ai.homePage.sessionTypes.lessonPlan");
    case "3":
      return t("ai.homePage.sessionTypes.ppt");
    case "4":
      return t("ai.homePage.sessionTypes.quiz");
    case "5":
      return t("ai.homePage.sessionTypes.code");
    case "6":
      return t("ai.homePage.sessionTypes.analysis");
    case "7":
      return t("ai.homePage.sessionTypes.image");
    default:
      return "";
  }
};

const translateAiQuotaName = (value: unknown) => {
  const text = String(value ?? "").trim();
  if (!text) return "";
  if (/^(对话类|AI自由问答|chat)$/i.test(text)) {
    return t("ai.homePage.quotaTypes.chat");
  }
  if (/^(智能生图|AI智能生图|image)$/i.test(text)) {
    return t("ai.homePage.quotaTypes.image");
  }
  return text;
};
...
const isTaskImageEmbedMode = computed(() => {
  return (
    props.taskImageEmbed ||
    props.taskChatEmbed ||
    String(route.query.embedMode || "").trim() === "task-image"
  );
});
...
const resolveAiSessionTypeLabel = (value: unknown) => {
  const text = String(value ?? "").trim();
  if (!text) return t("ai.homePage.sessionTypes.default");
  return resolveAiSessionTypeLabelBySessionType(text) || text;
};
...
const extractAiImageUrls = (payload: unknown): string[] => {
  ...
  Object.entries(record).forEach(([key, value]) => {
    if (/^(imageurl|image_url|fileurl|file_url)\d+$/i.test(key)) {
      const url = normalizeAiImageUrl(value);
      if (url) {
        result.add(url);
      }
    }
...
const syncAiRouteState = async () => {
  if (typeof window === "undefined") return;
  if (isTaskImageEmbedMode.value) return;
...
const hydrateImageModeBySessionId = async (sessionId: string) => {
  ...
  try {
    ...
    emit("session-loaded", {
      sessionId: String(chatSessionId.value || targetSessionId).trim(),
...
const buildAnalysisTargetText = () => {
  if (analysisIsAllSelected.value) {
    return t("ai.homePage.modePages.analysis.allGrades");
  }
...
const handleImageGenerate = async () => {
  ...
  try {
    ...
    if (isTaskImageEmbedMode.value && imageResultUrls.value.length > 0) {
      emit("generated", {
        sessionId: String(chatSessionId.value || resolvedSessionId || "").trim(),
        imageUrls: [...imageResultUrls.value],
        prompt,
      });
    }
  } catch (error: unknown) {
...
const handleCodeAssistantSubmit = async () => {
  ...
  try {
    ...
    if (chatSessionId.value && effectiveSessionType === 1) {
      emit("chat-session-ready", {
        sessionId: String(chatSessionId.value).trim(),
      });
    }
    ...
    if (isAbortError) {
      if (
        ...
        pendingAssistantMessage.content === t("ai.homePage.modePages.chat.thinkingContent")
      ) {
        pendingAssistantMessage.content = t("ai.homePage.messageActions.replyStoppedContinue");
      }
...
const handleAnalysisSubmit = async () => {
  ...
  const pendingAssistantMessage = reactive<AiChatMessage>({
    id: createAiChatMessageId(),
    role: "assistant",
    content: t("ai.homePage.modePages.chat.thinkingContent"),
    file: null,
    pending: true,
    stopped: false,
    thinkingMode: false,
...
const normalizeAiQuotaDetail = (rows: unknown): QuotaDetailItem[] => {
  ...
  return list
    ...
    .map((item) => ({
      ...item,
      quotaName: translateAiQuotaName(item.quotaName),
    }));
};
...
const historyTypeOptions = computed(() => {
  return [
    { value: "", label: t("ai.homePage.sessionTypes.all") },
    { value: "1", label: resolveAiSessionTypeLabelBySessionType("1") },
    { value: "2", label: resolveAiSessionTypeLabelBySessionType("2") },
    { value: "3", label: resolveAiSessionTypeLabelBySessionType("3") },
    { value: "4", label: resolveAiSessionTypeLabelBySessionType("4") },
    { value: "5", label: resolveAiSessionTypeLabelBySessionType("5") },
    { value: "6", label: resolveAiSessionTypeLabelBySessionType("6") },
    { value: "7", label: resolveAiSessionTypeLabelBySessionType("7") },
  ];
});
...
const resolvePreferredHistoryTypeFilter = () => {
  if (isImageMode.value) return "7";
  if (isAnalysisMode.value) return "6";
  if (isLessonPlanMode.value || lessonPlanChatActive.value) {
    return String(lessonPlanSessionType.value || 2);
  }
  if (isChatMode.value) {
    return String(chatSessionType.value || 1);
  }
  return "";
};
...
watch(locale, async () => {
  if (quotaDetail.value.length > 0 || quotaError.value) {
    await fetchQuotaDetail(true);
  }

  if (historyList.value.length > 0 || historyError.value) {
    await fetchAiSessionList(true);
  }
});
...
const fetchAiSessionList = async (silent = false) => {
  ...
  try {
    const shouldUseImageHistory = shouldUseImageHistoryList();
    const sessionType = shouldUseImageHistory ? "7" : (historyTypeFilter.value || undefined);
    const rows = shouldUseImageHistory
      ? await getImageList()
      : await getAiSessions(sessionType);
    if (shouldUseImageHistory) {
      imageRecentHistoryList.value = normalizeAiImagePreviewList(rows);
    } else if (historyTypeFilter.value !== "7") {
      imageRecentHistoryList.value = [];
    }
    historyList.value = shouldUseImageHistory
      ? normalizeAiImageHistoryList(rows)
      : normalizeAiSessionList(rows);
    if (
      !activeHistoryId.value ||
...
const handleOpenHistory = async () => {
  ...
  if (isImageMode.value && route.path.startsWith("/system/opt/ai-painting")) {
    ...
    if (isTaskImageEmbedMode.value) {
      nextQuery.embedMode = "task-image";
    }
    await router.push({
  ...
  const preferredHistoryTypeFilter = resolvePreferredHistoryTypeFilter();
  if (historyTypeFilter.value !== preferredHistoryTypeFilter) {
    historyTypeFilter.value = preferredHistoryTypeFilter;
    return;
  }
  await fetchAiSessionList(true);
  ...
  try {
    ...
    ElMessage.error(
      error instanceof Error
        && error.message
        ? error.message
        : t("ai.homePage.historyPanel.deleteError")
    );
  } finally {
  ...
  chatMessages.value = [
    {
      id: createAiChatMessageId(),
      role: "assistant",
      content: t("ai.homePage.historyPanel.loading"),
      file: null,
      pending: true,
    },
  ];
  ...
  try {
    ...
    ElMessage.error(
      error instanceof Error
        && error.message
        ? error.message
        : t("ai.homePage.historyPanel.loadError")
    );
  } finally {
    chatRequesting.value = false;
    scrollChatToBottom();
...
watch(
  ...
  async (sessionId) => {
    ...
    if (!nextSessionId || !isTaskImageEmbedMode.value) return;
    if (String(chatSessionId.value || "").trim() === nextSessionId) return;
    openImageView({ keepDraft: true });
    activeHistoryId.value = nextSessionId;
    chatSessionType.value = 7;
    chatSessionId.value = nextSessionId;
    searchKeyword.value = "";
    clearAiUploadFile();
    await hydrateImageModeBySessionId(nextSessionId);
    persistAiChatState();
  }
);
...
onMounted(() => {
  void (async () => {
    if (props.forceImageMode) {
      openImageView({ keepDraft: !props.resetImageModeOnMount });
      await fetchAiSessionList(true);
    } else if (props.forceChatMode) {
      startNewChat(1);
      if (!props.resetChatModeOnMount) {
        restoreAiChatState();
      }
      await fetchAiSessionList(true);
    } else {
...
.ai-assistant-page--task-image-embed {
  min-width: 0;
  height: 100%;
  overflow-x: hidden;
  overflow-y: auto;
...
.ai-assistant-container--task-image-embed {
  display: block;
  width: 100%;
  min-width: 0;
  min-height: 100%;
...
.ai-assistant-shell--task-image-embed {
  width: 100%;
  min-height: 100%;
  padding: 0;
  transform: none;
...
.ai-assistant-page--task-image-embed .ai-assistant-content {
  height: 100%;
}

.ai-assistant-page--task-image-embed .ai-image {
  margin-bottom: 0;
  min-height: 100%;
  border-radius: 0;
  border: none;
...
.ai-assistant-page--task-image-embed .ai-image__content {
  flex: 1;
  height: 100%;
  min-height: 0;
  align-items: stretch;
...
.ai-assistant-page--task-image-embed .ai-image__panel {
  overflow-y: auto;
  padding-bottom: 20px;
}

.ai-assistant-page--task-image-embed .ai-image__preview {
  min-height: 0;
  overflow: hidden;
}

.ai-assistant-page--task-image-embed .ai-image__preview-stage {
  min-height: 280px;
}

.ai-assistant-page--task-image-embed .ai-image__gallery {
  position: relative;
  z-index: 1;
  background: linear-gradient(180deg, rgba(244, 247, 251, 0) 0%, #f4f7fb 18%);
  padding-top: 14px;
}
