  ...
  <div class="h-full flex flex-col login-form">
      ...
      <div class="form-field">
        <div :class="[
          ...
          <img src="~/assets/images/classcode.png" alt="班级码" class="w-5 h-5 mr-3" />
          <input 
            type="text" 
        ...
        <p v-if="errors.classCode" class="field-error">请输入班级码</p>
      </div>
      ...
      <div class="form-field">
        <div :class="[
          ...
          <img src="~/assets/images/mima.png" alt="密码" class="w-5 h-5 mr-3" />
          <input 
        ...
        <p v-if="errors.classPassword" class="field-error">请输入密码</p>
      </div>
  </div>
</template>
