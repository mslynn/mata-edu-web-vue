<template>
  <div ref="graffitiPageRef" class="graffiti-page" :style="pageAdaptiveStyle">
    <div class="page-header">
      <nav class="graffiti-breadcrumb" :aria-label="t('graffitiRecognition.breadcrumbAria')">
        <button
          type="button"
          ...
          <section class="graffiti-hero">
            <div class="graffiti-hero__intro">
              <div class="graffiti-hero__copy">
                ...
                <h2>{{ t("graffitiRecognition.heroSubtitle") }}</h2>
                <p>{{ t("graffitiRecognition.heroDesc") }}</p>

                <button type="button" class="graffiti-primary-btn" @click="handleStartExperience">
...
const handleStartExperience = async () => {
  await router.push("/system/opt/graffiti/workbench");
};
...
onMounted(() => {
  ...
  window.addEventListener("resize", syncGraffitiLayoutWidth, { passive: true });
...
.graffiti-inline-btn .material-symbols-outlined {
  width: auto;
  height: auto;
  font-size: 18px;
}
