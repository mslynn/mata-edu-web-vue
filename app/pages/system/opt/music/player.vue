            ...
            <div class="music-player-vinyl-group">
              ...
              <div class="music-player-vinyl" :class="{ 'is-spinning': isPlaying }">
                ...
                <div class="music-player-vinyl__cover">
                  <img :src="currentWork.cover" :alt="currentWork.title" />
                </div>
...
const defaultWorks: MusicPlayerWorkItem[] = [
  {
    title: "深蓝回声",
    badge: "已完成",
    style: "POP",
...
const queryWork = computed<MusicPlayerWorkItem | null>(() => {
  ...
  return {
    title,
    badge: typeof route.query.badge === "string" && route.query.badge ? route.query.badge : "已完成",
...
const currentWork = computed<MusicPlayerWorkItem>(() => queryWork.value || defaultWorks[0]);

const audioSrc = computed(() => "/asr-demo/lecture-chinese-04.wav");
...
const pageAdaptiveStyle = computed(() => ({
  ...
  "--music-player-accent": currentWork.value.accent,
