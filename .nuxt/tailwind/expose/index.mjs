...
const config = { theme, corePlugins, plugins, content, safelist, presets, darkMode, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, safelist, presets, darkMode, prefix, important, separator, blocklist }